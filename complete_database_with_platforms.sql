-- ========================================
-- COMPLETE DATABASE SCHEMA WITH PLATFORM COMPATIBILITY
-- Gaming E-Commerce Application - ShopEase
-- ========================================
...
-- ========================================
-- 4. PRODUCT_PLATFORMS TABLE (NEW - Many-to-Many)
-- ========================================
...
-- ========================================
-- 11. VIEW FOR PRODUCTS WITH PLATFORMS
-- ========================================
...
-- View all products with their platforms
-- SELECT id, name, category, price, platform_names FROM v_products_with_platforms;
...
-- SELECT pl.name, COUNT(pp.product_id) as product_count
-- FROM platforms pl
